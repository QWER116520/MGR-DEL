...
def get_dataloader(path, max_len, batch_size, shuffle, bert_path, data_type, language, blip_path):
    ...
    if data_type == 'rationale':
        ...
        for item in data_list:
            ...
            tmp_data['category'] = category_dict.get(item.get('category', '社会'), 8)
        ...
        category = torch.tensor(df_data['category'].astype(int).to_numpy())
        ...
        dataset = TensorDataset(
            content_token_ids, content_masks,
            FTR_2_pred, FTR_2_acc,
            FTR_3_pred, FTR_3_acc,
            FTR_2_token_ids, FTR_2_masks,
            FTR_3_token_ids, FTR_3_masks,
            RP_token_ids, RP_masks,
            pixel_values,
            label, id, category
        )
