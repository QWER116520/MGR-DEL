...
from models.mge import Trainer as MGETrainer
    ...
    def main(self):
        ...
        for p, vs in param.items():
            ...
            for i, v in enumerate(vs):
                ...
                if self.config['model_name'] == 'MGE':
                    trainer = MGETrainer(self.config, self.writer)
                else:
