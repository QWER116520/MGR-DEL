...
parser.add_argument('--model_name', type=str, default='MGE')
...
parser.add_argument('--num_shared_expert', type=int, default=4)
parser.add_argument('--use_shared_experts', type=bool, default=True)
parser.add_argument('--use_enhanced_gating', type=bool, default=True)
parser.add_argument('--use_sequence_experts', type=bool, default=True)
parser.add_argument('--use_multimodal_fusion', type=bool, default=True)
...
parser.add_argument('--alpha_rp', type=float, default=1.0)
parser.add_argument('--alpha_img', type=float, default=1.0)
